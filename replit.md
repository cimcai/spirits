...
### Key Features
- **Pulsing Light Orbs**: Each AI philosopher displays a pulsing orb with intensity based on confidence (0-100% Value Score)
...
- **Three Philosophical Personas**: Stoic Philosopher (green), Existentialist Thinker (indigo), Socratic Questioner (amber)

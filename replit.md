...
- **Admin Panel**: Password-protected admin section at `/admin` (uses SESSION_SECRET); contains moderation queue and transcript export with speaker/date filtering in TXT/CSV/JSON formats
